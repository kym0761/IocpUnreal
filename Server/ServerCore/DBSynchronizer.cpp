...
namespace SP
{
	...
	class GetDBTables : public FDBBind<0, 13>
	{
	public:
		GetDBTables(FDBConnection& conn) : FDBBind(conn, QTablesAndColumns) {}
	...
	class GetDBIndexes : public FDBBind<0, 8>
	{
	public:
		GetDBIndexes(FDBConnection& conn) : FDBBind(conn, QIndexes) {}
	...
	class GetDBStoredProcedures : public FDBBind<0, 2>
	{
	public:
		GetDBStoredProcedures(FDBConnection& conn) : FDBBind(conn, QStoredProcedures) {}
